...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-20 max-w[1240px] mx-[100px] px-4 bg-white text-black'>
        ...
        <div>
            <Link to="/login" className='px-5 py-2 w-[100px] bg-gradient-to-r from-[#89ffbe] to-[#63ffed] text-[#1C5739] uppercase font-poppins font-medium rounded-lg'>Login</Link>
        </div>
        ...
        <h1 className='w-full px-4 text-3xl font-bold text-[#00df9a] mt-8'>Agrofarma</h1>
